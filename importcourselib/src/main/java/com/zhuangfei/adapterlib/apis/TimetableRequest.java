...
public class TimetableRequest {
    ...
    public static void loginUser(Context context, String type,String openid,Callback<ObjResult<TinyUserInfo>> callback) {
        loginUser(context, null, null, type, openid, null, null, null, null, null,callback);
    }
